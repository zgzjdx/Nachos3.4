...
AddrSpace::~AddrSpace()
{
   for (int i=0; i < numPages; i++) {
       memM->free(pageTable[i].physicalPage);
   }
   delete pageTable;
}
...
//----------------------------------------------------------------------
// AddrSpace::NewPages
//      allocate the pages for the process 
//      if failed, we just stop the process and free the pages had 
//      allocated.
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
// AddrSpace::physPages
//      return pageTable[order].physicalPage
//----------------------------------------------------------------------

int
AddrSpace::physPages(int order)
{
    return pageTable[order].physicalPage;
}
